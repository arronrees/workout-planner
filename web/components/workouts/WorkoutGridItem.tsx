...
export default function WorkoutGridItem({ workout }: Props) {
  return (
    <div className='p-4 border rounded text-xs flex justify-between items-center gap-4 relative bg-zinc-50'>
